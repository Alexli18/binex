...
export default function CostDashboard() {
  ...
  const { data, isLoading, error, refetch } = useCostDashboard(period);
  ...
  if (error) {
    return (
      <PageShell>
        <Breadcrumb items={[{ label: 'Costs & Budget', href: '/costs' }, { label: 'Cost Dashboard' }]} className="mb-4" />
        <ErrorState
  ...
  return (
    <PageShell>
      ...
      <PageHeader
        ...
        description="Track LLM API costs across your workflow runs"
        actions={
